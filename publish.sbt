...
pomExtra :=
  <url>https://github.com/hypertino/hyperbus-raml-sbt-plugin</url>
    <licenses>
      <license>
        <name>BSD-style</name>
    ...
    <scm>
      <url>git@github.com:hypertino/hyperbus-raml-sbt-plugin.git</url>
      <connection>scm:git:git@github.com:hypertino/hyperbus-raml-sbt-plugin.git</connection>
    </scm>
    <developers>
      <developer>
        <id>maqdev</id>
